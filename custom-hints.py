#!/usr/bin/env python3
"""
kitty -o 'map ctrl+g kitten hints --customize-processing custom-hints.py'
When you press the ctrl+g key you will be able to select a word to look it up in the Google dictionary.
